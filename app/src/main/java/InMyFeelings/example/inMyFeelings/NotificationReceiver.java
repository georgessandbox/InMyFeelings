    ...
    public void onReceive(Context context, Intent intent) {
        ...
        switch(intent.getAction()) {
            case "blue":
                ...
                Toast.makeText(context, "NeutralDay..", Toast.LENGTH_SHORT).show();
            ...
            case "red":
                ...
                Toast.makeText(context, "BadDay..", Toast.LENGTH_SHORT).show();
                notificationManager.cancelAll();

                break;
            case "green":
                sa.saveData(lala, "green",context );
                Toast.makeText(context, "HappyDay..", Toast.LENGTH_SHORT).show();
                notificationManager.cancelAll();
